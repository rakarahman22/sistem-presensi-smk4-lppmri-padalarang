...
<div class="container-fluid px-3 px-md-4 py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card rounded-4 p-3 h-100 d-flex align-items-center gap-3" style="background:#eff6ff;border:1px solid #bfdbfe;">
        ...
        {{-- Hadir Hari Ini --}}
        <div class="col-6 col-lg-3">
            <div class="stat-card rounded-4 p-3 h-100 d-flex align-items-center gap-3" style="background:#f0fdf4;border:1px solid #bbf7d0;">
        ...
        {{-- Alpa Hari Ini --}}
        <div class="col-6 col-lg-3">
            <div class="stat-card rounded-4 p-3 h-100 d-flex align-items-center gap-3" style="background:#fff1f2;border:1px solid #fecdd3;">
        ...
        {{-- Izin + Sakit --}}
        <div class="col-6 col-lg-3">
            <div class="stat-card rounded-4 p-3 h-100 d-flex align-items-center gap-3" style="background:#fffbeb;border:1px solid #fde68a;">
        ...
        <div class="col-12 col-xl-4">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header bg-white border-0 px-4 pt-4 pb-0">
                    ...
                    <p class="text-muted small mb-3 mt-1">Diurutkan berdasarkan alpa terbanyak</p>
                    <hr class="mt-0 mb-0">
                </div>
                <div class="card-body px-3 py-2" style="max-height:340px;overflow-y:auto;">
                    ...
                    <div class="rekap-kelas-item px-2 py-2">
                        <div class="d-flex justify-content-between align-items-start mb-1">
                            <div>
                                <span class="fw-semibold small text-dark">{{ $kls['nama_kelas'] }}</span>
                                <span class="text-muted" style="font-size:.7rem;"> · {{ $kls['jurusan'] ?? '' }}</span>
                            </div>
                            <span class="badge rounded-pill px-2"
                                style="font-size:.68rem;background:{{ $kls['pct_hadir'] >= 80 ? '#dcfce7' : ($kls['pct_hadir'] >= 60 ? '#fef3c7' : '#ffe4e6') }};
                                       color:{{ $kls['pct_hadir'] >= 80 ? '#166534' : ($kls['pct_hadir'] >= 60 ? '#92400e' : '#9f1239') }}">
                                {{ $kls['pct_hadir'] }}% hadir
                            </span>
                        </div>
                        {{-- Mini progress --}}
                        ...
                        <div class="d-flex gap-2" style="font-size:.7rem;color:#64748b;">
                            <span><i class="bi bi-check-circle-fill text-success me-1"></i>{{ $kls['hadir'] }}</span>
                            <span><i class="bi bi-exclamation-circle-fill text-warning me-1"></i>{{ $kls['izin_sakit'] }}</span>
                        ...
                        <tr>
                            ...
                            <td class="py-3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="fw-semibold text-dark small">{{ $p->siswa->nama_siswa ?? '-' }}</span>
                                </div>
                            </td>
...
<style>
    ...
    .stat-lbl  { font-size:.72rem;font-weight:600;text-transform:uppercase;letter-spacing:.04em;margin-top:2px; }
    .stat-sub  { font-size:.68rem;color:#94a3b8;margin-top:1px; }

    .legend-dot { display:inline-block;width:8px;height:8px;border-radius:50%; }

    .rekap-kelas-item { border-bottom:1px solid #f1f5f9; }
    .rekap-kelas-item:last-child { border-bottom:none; }
...
<script>
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                legend: { display: false }, // legend manual di atas
                tooltip: {
