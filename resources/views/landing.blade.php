...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&family=Playfair+Display:wght@700;800&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        *::after {
        ...
        .ava-b {
            background: rgba(59, 130, 196, 0.3);
            color: #93C5FD;
        }
        ...
        .feat-card:hover {
            box-shadow: 0 8px 28px rgba(26, 79, 138, 0.1);
        ...
        .footer-links li {
            ...
            gap: 10px;
            /* Jarak antara ikon FontAwesome dan teks */
        }

        .footer-links i {
            margin-top: 4px;
            width: 16px;
            /* Memastikan icon berjejer rapi vertikal */
            text-align: center;
        }
        ...
        .footer-bottom {
            ...
            text-align: center;
            /* Membuat teks copyright berada di tengah */
        }
...
<body>
            ...
            <a href="#" class="nav-brand">
                <div class="nav-emblem">
                    <svg viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13 2L3 7v6c0 5.55 4.27 10.74 10 12 5.73-1.26 10-6.45 10-12V7L13 2z" fill="#0B2545"
                            stroke="#0B2545" stroke-width="0.5" />
    ...
    <div class="infobar" id="tentang">
        <div class="infobar-inner">
            ...
            <div class="infobar-stats">
                <div class="ib-stat"><span class="ib-n">4</span><span class="ib-l">Jurusan</span></div>
                <div class="ib-div" aria-hidden="true"></div>
                <div class="ib-stat"><span class="ib-n">55</span><span class="ib-l">Guru &amp; Staff</span></div>
                <div class="ib-div" aria-hidden="true"></div>
                <div class="ib-stat"><span class="ib-n">900</span><span class="ib-l">Siswa Aktif</span></div>
                <div class="ib-div" aria-hidden="true"></div>
    ...
    <div class="sec-bg" id="fitur">
        <div class="section">
            ...
            <p class="sec-desc">Dirancang khusus untuk kebutuhan sekolah kejuruan dengan fitur lengkap dan antarmuka
                yang mudah digunakan siapa saja.</p>

            <div class="feat-grid">
                <div class="feat-card">
                    <div class="fi fi-blue"><i class="ti ti-clock-check" aria-hidden="true"></i></div>
                    <div class="ft">Presensi Real-time</div>
                    <div class="fd">Data kehadiran langsung tercatat saat guru memasukkan absensi per mata
                        pelajaran, tanpa rekap manual.</div>
                </div>
                <div class="feat-card">
                    <div class="fi fi-gold"><i class="ti ti-chart-bar" aria-hidden="true"></i></div>
                    <div class="ft">Laporan &amp; Statistik</div>
                    <div class="fd">Laporan lengkap per siswa, kelas, dan mata pelajaran. Ekspor ke PDF dan Excel
                        dengan satu klik.</div>
                </div>
                <div class="feat-card">
                    <div class="fi fi-green"><i class="ti ti-message-circle" aria-hidden="true"></i></div>
                    <div class="ft">Notifikasi Otomatis</div>
                    <div class="fd">Orang tua mendapat notifikasi jika siswa tidak hadir atau ketidakhadiran
                        melampaui batas yang ditentukan.</div>
                </div>
                <div class="feat-card">
                    <div class="fi fi-blue"><i class="ti ti-calendar-event" aria-hidden="true"></i></div>
                    <div class="ft">Jadwal Terintegrasi</div>
                    <div class="fd">Presensi terintegrasi langsung dengan jadwal pelajaran sehingga absensi per
                        mapel tercatat otomatis.</div>
                </div>
                <div class="feat-card">
                    <div class="fi fi-gold"><i class="ti ti-shield-check" aria-hidden="true"></i></div>
                    <div class="ft">Keamanan Data</div>
                    <div class="fd">Autentikasi berlapis dengan hak akses berbeda per peran: Admin, Guru, dan
                        Siswa.</div>
                </div>
                <div class="feat-card">
                    <div class="fi fi-green"><i class="ti ti-device-mobile" aria-hidden="true"></i></div>
                    <div class="ft">Responsive &amp; Mobile</div>
                    <div class="fd">Dapat diakses dari smartphone, tablet, dan komputer tanpa perlu menginstal
                        aplikasi tambahan.</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section" id="portal">
        ...
        <p class="sec-desc">
            ...
            Setiap peran memiliki hak akses dan tampilan yang berbeda.
        </p>
        ...
        <div class="roles-grid">
            ...
            <div class="role-card">
                ...
                <div class="rd">
                    Kelola data master siswa, guru, kelas, jurusan,
                    jadwal pelajaran, dan seluruh konfigurasi sistem.
                </div>

                <a href="{{ route('login.form', 'admin') }}" class="role-btn">
                    <i class="ti ti-login" aria-hidden="true"></i>
                    Masuk sebagai Admin
                </a>
            </div>
            ...
            <div class="role-card">
                ...
                <div class="rd">
                    Catat presensi per mata pelajaran, pantau rekap
                    kehadiran siswa, dan kelola surat izin digital.
                </div>

                <a href="{{ route('login.form', 'guru') }}" class="role-btn green">
                    <i class="ti ti-login" aria-hidden="true"></i>
                    Masuk sebagai Guru
                </a>
            </div>
            ...
            <div class="role-card">
                ...
                <div class="rd">
                    Lihat rekap kehadiran pribadi, ajukan surat izin
                    secara online, dan pantau persentase kehadiran Anda.
                </div>

                <a href="{{ route('login.form', 'siswa') }}" class="role-btn gold">
                    <i class="ti ti-login" aria-hidden="true"></i>
                    Masuk sebagai Siswa
                </a>
            </div>
            ...
            {{-- WALI SISWA --}}
            <div class="role-card">
                <div class="ri ri-wali">
                    <i class="ti ti-users" aria-hidden="true"></i>
                </div>

                <div class="rt">Wali Siswa</div>

                <div class="rd">
                    Pantau kehadiran anak secara real-time, lihat riwayat
                    presensi, serta terima informasi terkait aktivitas siswa.
                </div>

                <a href="{{ route('login.form', 'wali') }}" class="role-btn orange">
                    <i class="ti ti-login" aria-hidden="true"></i>
                    Masuk sebagai Wali Siswa
                </a>
            </div>
    ...
    <footer class="footer">
        <div class="footer-container">
            <div class="footer-col">
                <h4 class="footer-title">SMK 4 LPPM RI</h4>
                <p class="footer-text">
                    Sekolah Menengah Kejuruan Swasta berakreditasi <strong>A</strong> yang berdedikasi untuk mencetak
                    generasi unggul dan siap kerja.
                </p>
                <p class="footer-text" style="margin-top: 10px;">
                    <strong>NPSN:</strong> 20267646
                </p>
            </div>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    <li><i class="fas fa-map-marker-alt"></i> Jl. Letkol GA Manulang No. 132, Desa Padalarang, Kec.
                        Padalarang, Kab. Bandung Barat, Prov. Jawa Barat</li>
                    <li><i class="fas fa-phone"></i> Telp: (022) 6810404</li>
                    <li><i class="fas fa-envelope"></i> <a href="mailto:smk4lppmri@gmail.com">smk4lppmri@gmail.com</a>
                    </li>
                </ul>
            </div>

            <div class="footer-col">
                <h4 class="footer-title">Tautan Resmi</h4>
                <ul class="footer-links">
                    <li><a href="http://www.smk4lppmri.sch.id." target="_blank"><i class="fas fa-globe"></i> Website
                            Sekolah</a></li>
                    <li><a href="https://www.instagram.com/smk4lppmri/" target="_blank"><i
                                class="fab fa-instagram"></i> Instagram (@smk4lppmri)</a></li>
                </ul>
            </div>
        </div>
